...
public class Point {
   ...
   protected double theta = 0; //角度
   protected double rho = 0; //Remember that rho is the distance from the origin

   protected boolean polar = true; //极坐标
   protected boolean rectangular = true; //矩形
